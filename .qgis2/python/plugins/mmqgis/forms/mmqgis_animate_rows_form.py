...
class Ui_mmqgis_animate_rows_form(object):
    def setupUi(self, mmqgis_animate_rows_form):
        ...
        mmqgis_animate_rows_form.resize(394, 320)
        ...
        self.browseoutfile.setGeometry(QtCore.QRect(300, 240, 79, 31))
        self.browseoutfile.setObjectName(_fromUtf8("browseoutfile"))
        self.label = QtGui.QLabel(mmqgis_animate_rows_form)
        self.label.setGeometry(QtCore.QRect(20, 220, 161, 22))
        self.label.setObjectName(_fromUtf8("label"))
        self.outdirname = QtGui.QLineEdit(mmqgis_animate_rows_form)
        self.outdirname.setGeometry(QtCore.QRect(20, 240, 271, 31))
        self.outdirname.setReadOnly(False)
        self.outdirname.setObjectName(_fromUtf8("outdirname"))
        self.cumulative = QtGui.QCheckBox(mmqgis_animate_rows_form)
        self.cumulative.setGeometry(QtCore.QRect(20, 190, 101, 19))
        self.cumulative.setObjectName(_fromUtf8("cumulative"))
    ...
    def retranslateUi(self, mmqgis_animate_rows_form):
        ...
        self.cumulative.setText(_translate("mmqgis_animate_rows_form", "Cumulative", None))
